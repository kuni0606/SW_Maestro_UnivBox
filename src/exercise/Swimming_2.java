...
public class Swimming_2 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "우혁제",
				"광주체육고등학교 3학년(수영) 1995년생 ", R.drawable.unistar_swimming_woohj));
		adapter.add(new CData(getApplicationContext(), "김지현",
				"광주체육고등학교 3학년(수영_배영) 1994년생  ",
				R.drawable.unistar_swimming_kimjh));
		adapter.add(new CData(getApplicationContext(), "남상지",
				"광주체육고등학교 1학년(수영_자유형) 1996년생 ",
				R.drawable.unistar_swimming_namsj));
		adapter.add(new CData(getApplicationContext(), "전이연",
				"광주체육고등학교 3학년(수영_접형) 1994년생 ",
				R.drawable.unistar_swimmingjeonyy));
