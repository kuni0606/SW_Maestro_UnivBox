...
public class Shoot_2 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "주혁",
				"남부대학교 3학년(사격) 1992년생 ", R.drawable.unistar_shotgun_jooh));
		adapter.add(new CData(getApplicationContext(), "송수주",
				"남부대학교 4학년(사격) 1991년생 ", R.drawable.unistar_shotgun_songsj));
		adapter.add(new CData(getApplicationContext(), "김고운",
				"전남여자고등학교 3학년(사격) 1995년생  ", R.drawable.unistar_shotgun_kimgu));
		adapter.add(new CData(getApplicationContext(), "김용경",
				"광주체육고등학교 3학년(사격) 1994년생 ", R.drawable.unistar_shotgun_kimyk));
