...
public class Badminton_2 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "최유리",
				"조선대학교 1학년(배드민턴) 1994년생 ", R.drawable.unistar_badminton_choiyr));
	
		adapter.add(new CData(getApplicationContext(), "김보람",
				"광주체육고등학교 3학년(배드민턴) 1994년생  ", R.drawable.unistar_badminton_kimbr));

		adapter.add(new CData(getApplicationContext(), "이명하",
				"광주체육고등학교 3학년(배드민턴) 1994년생  ", R.drawable.unistar_badminton_leemh));
