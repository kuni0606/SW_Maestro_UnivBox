...
public class Badminton_3 extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		MyItem2 mi;
		mi = new MyItem2(R.drawable.hwasooncenter120, "화순 하니움 문화 스포츠센터", "주소 : 전남 화순군 화순읍 학포로 2698");arItem.add(mi);
		
		MyListAdapter2 MyAdapter = new MyListAdapter2(this, R.layout.stadium ,arItem);
...
class MyItem2
{
	MyItem2(int aImage, String aName, String aNick)
	{
		Image=aImage;
		Name=aName;
		Nick=aNick;
	...
	public View getView(final int position, View convertView, ViewGroup parent)
	{
		...
		btn.setOnClickListener(new Button.OnClickListener(){
			public void onClick(View v){
				if(arSrc.get(position).Name == "화순 하니움 문화 스포츠센터")
				{
					Intent intent = new Intent(maincon, hwasooncenter.class);
