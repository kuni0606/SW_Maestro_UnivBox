...
public class Diving_2 extends Activity  {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "홍정석",
				"광주체육고등학교 3학년(다이빙) 1995년생", R.drawable.unistar_swimming_hongjs));
		adapter.add(new CData(getApplicationContext(), "류민재",
				"광주체육고등학교 2학년(싱크로다이빙) 1996년생 ", R.drawable.unistar_swimming_ryumj));
