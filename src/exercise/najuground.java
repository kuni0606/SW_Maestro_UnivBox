...
public class najuground extends NMapActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		poiData.addPOIitem(126.7197438, 35.0122694, "나주공설운동장", markerId, 0);
		poiData.endPOIdata();
		...
		mMapView.setOnMapStateChangeListener(new OnMapStateChangeListener() {
			...
			public void onMapInitHandler(NMapView arg0, NMapError errorInfo) {
				...
				if (errorInfo == null) { // success
					mMapController.setMapCenter(new NGeoPoint(126.7197438, 35.0122694),11);
				} else { // fail
