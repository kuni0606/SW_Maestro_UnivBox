...
public class jangsunglake extends NMapActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		poiData.addPOIitem(126.834368, 35.3843337, "장성호", markerId, 0);
		poiData.endPOIdata();
		...
		mMapView.setOnMapStateChangeListener(new OnMapStateChangeListener() {
			...
			public void onMapInitHandler(NMapView arg0, NMapError errorInfo) {
				...
				if (errorInfo == null) { // success
					mMapController.setMapCenter(new NGeoPoint(126.834368, 35.3843337),11);
				} else { // fail
