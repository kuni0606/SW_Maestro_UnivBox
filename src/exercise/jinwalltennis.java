...
public class jinwalltennis extends NMapActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		poiData.addPOIitem(126.9023563, 35.1118475, "진월 테니스장", markerId, 0);
		poiData.endPOIdata();
		...
		mMapView.setOnMapStateChangeListener(new OnMapStateChangeListener() {
			...
			public void onMapInitHandler(NMapView arg0, NMapError errorInfo) {
				...
				if (errorInfo == null) { // success
					mMapController.setMapCenter(new NGeoPoint(126.9023563, 35.1118475),11);
				} else { // fail
