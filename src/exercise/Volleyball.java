...
@Override
 protected void onCreate(Bundle savedInstanceState) {
  ...
  setContentView(R.layout.volleyballlayout);
  ...
  tabSpec1.setContent(new Intent(this, Volleyball_1.class)); // Tab Content
  tabs.addTab(tabSpec1);
 
  TabSpec tabSpec2 = tabs.newTabSpec("선수");
  tabSpec2.setIndicator("선수");
  tabSpec2.setContent(new Intent(this, Volleyball_2.class)); // Tab Content
  tabs.addTab(tabSpec2);
 
  // Tab3 Setting
  TabSpec tabSpec3 = tabs.newTabSpec("경기장");
  tabSpec3.setIndicator("경기장");
  tabSpec3.setContent(new Intent(this, Volleyball_3.class)); // Tab Content
