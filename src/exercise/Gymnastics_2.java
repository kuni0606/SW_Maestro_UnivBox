...
public class Gymnastics_2 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter.add(new CData(getApplicationContext(), "한소리",
				"광주체육고등학교 3학년(기계체조) 1995년생 ", R.drawable.unistar_machine_hansr));
		adapter.add(new CData(getApplicationContext(), "김도영",
				"광주체육고등학교 2학년(기계체조) 1995년생 ", R.drawable.unistar_machine_kimdy));
		adapter.add(new CData(getApplicationContext(), "설나경",
				"광주체육고등학교 2학년(기계체조) 1995년생 ", R.drawable.unistar_machine_seolnk));
