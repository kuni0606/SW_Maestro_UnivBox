...
public class mokpofootball extends NMapActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		poiData.addPOIitem(126.3993869, 34.82935, "목포 국제 축구센터", markerId, 0);
		poiData.endPOIdata();
		...
		mMapView.setOnMapStateChangeListener(new OnMapStateChangeListener() {
			...
			public void onMapInitHandler(NMapView arg0, NMapError errorInfo) {
				...
				if (errorInfo == null) { // success
					mMapController.setMapCenter(new NGeoPoint(126.3993869, 34.82935),11);
				} else { // fail
