...
public class muanchodangunivgym extends NMapActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		poiData.addPOIitem(126.4740883, 34.9755567, "무안 초당대 체육관", markerId, 0);
		poiData.endPOIdata();
		...
		mMapView.setOnMapStateChangeListener(new OnMapStateChangeListener() {
			...
			public void onMapInitHandler(NMapView arg0, NMapError errorInfo) {
				...
				if (errorInfo == null) { // success
					mMapController.setMapCenter(new NGeoPoint(126.4740883, 34.9755567),11);
				} else { // fail
